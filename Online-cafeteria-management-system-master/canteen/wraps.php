...
<tr>
<td rowspan="15"align="center"><img src="Images\wraps2.jpg" alt="sand" ></img></td>
<td><font style="font-family:segoe print;color:yellow;font-weight:bold;font-size:50pt;font-style:italics;">Wraps</font></td>
<td> </td>
</tr>
<tr>
...
<select name="name">
<option value="60">Chargrilled Veggie</option>
<option value="61">Paprika Paneer</option>
<option value="62">Swiss Grilled Mushroom Melt</option>
<option value="63">Crispy Poutine Slaw</option>
<option value="64">Chicken Ham & Cheese</option>
<option value="65">Pump It Up</option>
<option value="66">Pulled BBQ Chicken</option>
<option value="67">Club Sandwich</option>
</select>
